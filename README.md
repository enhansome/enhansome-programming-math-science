...
* [Maths, CS & AI Compendium](https://github.com/HenryNdubuaku/maths-cs-ai-compendium) ⭐ 7,391 | 🐛 15 | 🌐 TypeScript | 📅 2026-07-18 by *Henry Ndubuaku*
...
* [Machine Learning Engineering Open Book](https://github.com/stas00/ml-engineering) ⭐ 18,861 | 🐛 4 | 🌐 Python | 📅 2026-08-31 by *Stas Bekman*
...
* [Mathematical Foundations of Reinforcement Learning](https://github.com/MathFoundationRL/Book-Mathematical-Foundation-of-Reinforcement-Learning) ⭐ 17,631 | 🐛 0 | 🌐 MATLAB | 📅 2026-08-10 by *Shiyu Zhao*
...
* [Monte-Carlo Graph Search from First Principles](https://github.com/lightvector/KataGo/blob/master/docs/GraphSearch.md) ⭐ 5,060 | 🐛 489 | 🌐 C++ | 📅 2026-08-30 by *David J Wu*
...
* [GameShell: a "game" to teach the Unix shell](https://github.com/phyver/GameShell) ⭐ 3,164 | 🐛 11 | 🌐 Shell | 📅 2026-05-05 by *Pierre Hyvernat*
...
* [A Compiler Writing Journey](https://github.com/DoctorWkt/acwj) ⭐ 13,391 | 🐛 25 | 🌐 C | 📅 2026-06-06 by *Warren*
...
* [Performance Analysis and Tunning on Modern CPUs](https://github.com/dendibakh/perf-book) ⭐ 3,635 | 🐛 21 | 🌐 TeX | 📅 2025-06-09 by *Denis Bakhvalov*
...
* [The Little Book of Linear Algebra](https://github.com/the-litte-book-of/linear-algebra) ⭐ 1,996 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-03-16 by *Duc-Tam Nguyen*
...
* [Linux Basics for Hackers](https://github.com/ahegazy0/linux-basics-for-hackers-notes) ⭐ 1,306 | 🐛 0 | 📅 2026-06-04 by *Abdulrahman Hegazy*
...
* [Introduction to Bash Scripting](https://github.com/bobbyiliev/introduction-to-bash-scripting) ⭐ 6,326 | 🐛 10 | 🌐 HTML | 📅 2026-02-11 by *Bobby Iliev*
...
* [30 Days Of Python](https://github.com/Asabeneh/30-Days-Of-Python) ⭐ 72,433 | 🐛 202 | 🌐 Python | 📅 2026-08-27 by *Asabeneh*

* [Scientific Visualization: Python + Matplotlib](https://github.com/rougier/scientific-visualization-book) ⭐ 11,464 | 🐛 18 | 🌐 Python | 📅 2026-01-04 by *Nicolas Rougier*
...
* [Mathematics for Robotics](https://github.com/michiganrobotics/rob501) ⭐ 2,950 | 🐛 1 | 📅 2022-03-21 by *Jessy Grizzle*

* [Robotics & ROS 2 Essentials](https://github.com/henki-robotics/robotics_essentials_ros2) ⭐ 2,592 | 🐛 1 | 🌐 C++ | 📅 2025-11-25
...
* [What happens when you type google.com into your browser's address box and press enter?](https://github.com/alex/what-happens-when) ⭐ 43,303 | 🐛 2,066 | 📅 2024-08-19 by *Alex Gaynor*
...
* [Playing with code](https://haqr.eu) by *Dmitry V. Sokolov*
  ...
  * **On the [author's GitHub](https://github.com/ssloy)**
    * [Tiny renderer or how OpenGL works: software rendering in 500 lines of code](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,163 | 🐛 4 | 🌐 C++ | 📅 2026-07-29
...
* [Build Your Own X](https://github.com/danistefanovic/build-your-own-x/blob/master/README.md) ⭐ 544,328 | 🐛 640 | 🌐 Markdown | 📅 2026-07-14

* [Project Based Learning](https://github.com/practical-tutorials/project-based-learning/blob/master/README.md) ⭐ 281,542 | 🐛 275 | 🌐 Python | 📅 2026-08-31
