...
* [Maths, CS & AI Compendium](https://github.com/HenryNdubuaku/maths-cs-ai-compendium) ⭐ 7,466 | 🐛 15 | 🌐 TypeScript | 📅 2026-07-18 by *Henry Ndubuaku*
...
* [Machine Learning Engineering Open Book](https://github.com/stas00/ml-engineering) ⭐ 18,935 | 🐛 4 | 🌐 Python | 📅 2026-09-04 by *Stas Bekman*
...
* [Mathematical Foundations of Reinforcement Learning](https://github.com/MathFoundationRL/Book-Mathematical-Foundation-of-Reinforcement-Learning) ⭐ 17,717 | 🐛 1 | 🌐 MATLAB | 📅 2026-09-08 by *Shiyu Zhao*
...
* [Monte-Carlo Graph Search from First Principles](https://github.com/lightvector/KataGo/blob/master/docs/GraphSearch.md) ⭐ 5,091 | 🐛 493 | 🌐 C++ | 📅 2026-09-07 by *David J Wu*
...
* [GameShell: a "game" to teach the Unix shell](https://github.com/phyver/GameShell) ⭐ 3,294 | 🐛 13 | 🌐 Shell | 📅 2026-05-05 by *Pierre Hyvernat*
...
* [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,878 | 🐛 18 | 🌐 C++ | 📅 2023-06-25
...
* [FFmpeg School of Assembly Language](https://github.com/FFmpeg/asm-lessons) ⭐ 12,142 | 🐛 25 | 📅 2026-02-22
...
* [Introduction to Bash Scripting](https://github.com/bobbyiliev/introduction-to-bash-scripting) ⭐ 6,339 | 🐛 10 | 🌐 HTML | 📅 2026-02-11 by *Bobby Iliev*
...
* [30 Days Of Python](https://github.com/Asabeneh/30-Days-Of-Python) ⭐ 73,135 | 🐛 206 | 🌐 Python | 📅 2026-08-27 by *Asabeneh*

* [Scientific Visualization: Python + Matplotlib](https://github.com/rougier/scientific-visualization-book) ⭐ 11,506 | 🐛 18 | 🌐 Python | 📅 2026-01-04 by *Nicolas Rougier*
...
* [ZX Spectrum Next: Assembly Developer Guide](https://github.com/tomaz/zx-next-dev-guide) ⭐ 187 | 🐛 14 | 🌐 TeX | 📅 2023-03-27 by *Tomaz Kragelj*
...
* [Mathematics for Robotics](https://github.com/michiganrobotics/rob501) ⭐ 2,970 | 🐛 1 | 📅 2022-03-21 by *Jessy Grizzle*
...
* [Learn Vim (the Smart Way)](https://github.com/iggredible/Learn-Vim) ⭐ 15,213 | 🐛 18 | 🌐 Dockerfile | 📅 2026-09-07 by *Igor Irianto*
...
* [What happens when you type google.com into your browser's address box and press enter?](https://github.com/alex/what-happens-when) ⭐ 43,311 | 🐛 2,065 | 📅 2024-08-19 by *Alex Gaynor*
...
* [Playing with code](https://haqr.eu) by *Dmitry V. Sokolov*
  ...
  * **On the [author's GitHub](https://github.com/ssloy)**
    * [Tiny renderer or how OpenGL works: software rendering in 500 lines of code](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,205 | 🐛 4 | 🌐 C++ | 📅 2026-07-29
    * [Understandable RayTracing in 256 lines of bare C++](https://github.com/ssloy/tinyraytracer/wiki) ⭐ 5,364 | 🐛 16 | 🌐 C++ | 📅 2023-07-07
...
* [Build Your Own X](https://github.com/danistefanovic/build-your-own-x/blob/master/README.md) ⭐ 546,026 | 🐛 641 | 🌐 Markdown | 📅 2026-07-14

* [Project Based Learning](https://github.com/practical-tutorials/project-based-learning/blob/master/README.md) ⭐ 282,618 | 🐛 267 | 🌐 Python | 📅 2026-09-07

* [Awesome Math Books](https://github.com/valeman/Awesome_Math_Books) ⭐ 7,080 | 🐛 7 | 📅 2026-08-14

* [Max Slater's Bookmarks](https://github.com/TheNumbat/Lists) ⭐ 356 | 🐛 0 | 📅 2026-01-24
