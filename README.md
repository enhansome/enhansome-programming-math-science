...
* [Maths, CS & AI Compendium](https://github.com/HenryNdubuaku/maths-cs-ai-compendium) ⭐ 7,523 | 🐛 15 | 🌐 TypeScript | 📅 2026-07-18 by *Henry Ndubuaku*
...
* [Machine Learning Engineering Open Book](https://github.com/stas00/ml-engineering) ⭐ 19,011 | 🐛 4 | 🌐 Python | 📅 2026-09-12 by *Stas Bekman*
...
* [Mathematical Foundations of Reinforcement Learning](https://github.com/MathFoundationRL/Book-Mathematical-Foundation-of-Reinforcement-Learning) ⭐ 17,832 | 🐛 1 | 🌐 MATLAB | 📅 2026-09-15 by *Shiyu Zhao*
...
* [Monte-Carlo Graph Search from First Principles](https://github.com/lightvector/KataGo/blob/master/docs/GraphSearch.md) ⭐ 5,123 | 🐛 491 | 🌐 C++ | 📅 2026-09-16 by *David J Wu*
...
* [The Little Book of algorithms](https://github.com/little-book-of/algorithms) ⭐ 562 | 🐛 0 | 🌐 TeX | 📅 2025-10-25 by *Duc-Tam Nguyen*
...
* [GameShell: a "game" to teach the Unix shell](https://github.com/phyver/GameShell) ⭐ 3,315 | 🐛 16 | 🌐 Shell | 📅 2026-05-05 by *Pierre Hyvernat*
...
* [DirectX-Graphics-Samples](https://github.com/microsoft/DirectX-Graphics-Samples) ⭐ 6,838 | 🐛 113 | 🌐 C++ | 📅 2026-08-14
...
* [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,910 | 🐛 18 | 🌐 C++ | 📅 2023-06-25
...
* [Linux Basics for Hackers](https://github.com/ahegazy0/linux-basics-for-hackers-notes) ⭐ 1,711 | 🐛 0 | 📅 2026-09-12 by *Abdulrahman Hegazy*
...
* [FFmpeg School of Assembly Language](https://github.com/FFmpeg/asm-lessons) ⭐ 12,152 | 🐛 25 | 📅 2026-02-22
...
* [30 Days Of Python](https://github.com/Asabeneh/30-Days-Of-Python) ⭐ 74,059 | 🐛 212 | 🌐 Python | 📅 2026-09-10 by *Asabeneh*

* [Scientific Visualization: Python + Matplotlib](https://github.com/rougier/scientific-visualization-book) ⭐ 11,544 | 🐛 18 | 🌐 Python | 📅 2026-01-04 by *Nicolas Rougier*
...
* [Mathematics for Robotics](https://github.com/michiganrobotics/rob501) ⭐ 2,982 | 🐛 1 | 📅 2022-03-21 by *Jessy Grizzle*

* [Robotics & ROS 2 Essentials](https://github.com/henki-robotics/robotics_essentials_ros2) ⭐ 2,623 | 🐛 1 | 🌐 C++ | 📅 2025-11-25
...
* [What happens when you type google.com into your browser's address box and press enter?](https://github.com/alex/what-happens-when) ⭐ 43,321 | 🐛 2,066 | 📅 2024-08-19 by *Alex Gaynor*
...
* [Playing with code](https://haqr.eu) by *Dmitry V. Sokolov*
  ...
  * **On the [author's GitHub](https://github.com/ssloy)**
    * [Tiny renderer or how OpenGL works: software rendering in 500 lines of code](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,257 | 🐛 4 | 🌐 C++ | 📅 2026-07-29
    * [Understandable RayTracing in 256 lines of bare C++](https://github.com/ssloy/tinyraytracer/wiki) ⭐ 5,370 | 🐛 16 | 🌐 C++ | 📅 2023-07-07
...
* [Build Your Own X](https://github.com/danistefanovic/build-your-own-x/blob/master/README.md) ⭐ 548,056 | 🐛 644 | 🌐 Markdown | 📅 2026-07-14

* [Project Based Learning](https://github.com/practical-tutorials/project-based-learning/blob/master/README.md) ⭐ 283,760 | 🐛 253 | 🌐 Python | 📅 2026-09-14

* [Awesome Math Books](https://github.com/valeman/Awesome_Math_Books) ⭐ 7,222 | 🐛 7 | 📅 2026-08-14
