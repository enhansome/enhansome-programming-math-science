...
* [Maths, CS & AI Compendium](https://github.com/HenryNdubuaku/maths-cs-ai-compendium) ⭐ 7,533 | 🐛 15 | 🌐 TypeScript | 📅 2026-07-18 by *Henry Ndubuaku*
...
* [Machine Learning Engineering Open Book](https://github.com/stas00/ml-engineering) ⭐ 19,022 | 🐛 4 | 🌐 Python | 📅 2026-09-12 by *Stas Bekman*
...
* [Matrix Calculus (for Machine Learning and Beyond)](https://arxiv.org/abs/2501.14787) by *Paige Bright*, *Alan Edelman*, and *Steven G. Johnson*
  * [GitHub repository](https://github.com/mitmath/matrixcalc) ⭐ 613 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-01-31
...
* [Mathematical Foundations of Reinforcement Learning](https://github.com/MathFoundationRL/Book-Mathematical-Foundation-of-Reinforcement-Learning) ⭐ 17,845 | 🐛 1 | 🌐 MATLAB | 📅 2026-09-15 by *Shiyu Zhao*
...
* [Disciplined AI Software Development](https://github.com/Varietyz/Disciplined-AI-Software-Development) ⭐ 408 | 🐛 1 | 🌐 Python | 📅 2026-04-02 by *Jay Baleine*
...
* [Monte-Carlo Graph Search from First Principles](https://github.com/lightvector/KataGo/blob/master/docs/GraphSearch.md) ⭐ 5,129 | 🐛 491 | 🌐 C++ | 📅 2026-09-20 by *David J Wu*
...
* [GameShell: a "game" to teach the Unix shell](https://github.com/phyver/GameShell) ⭐ 3,316 | 🐛 16 | 🌐 Shell | 📅 2026-05-05 by *Pierre Hyvernat*
...
* [DirectX-Graphics-Samples](https://github.com/microsoft/DirectX-Graphics-Samples) ⭐ 6,836 | 🐛 113 | 🌐 C++ | 📅 2026-08-14
...
* [A Guide to Modern OpenGL Functions](https://github.com/fendevel/Guide-to-Modern-OpenGL-Functions) ⭐ 1,465 | 🐛 3 | 📅 2021-11-08
...
* [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,912 | 🐛 18 | 🌐 C++ | 📅 2023-06-25
...
* [Performance Analysis and Tunning on Modern CPUs](https://github.com/dendibakh/perf-book) ⭐ 3,654 | 🐛 21 | 🌐 TeX | 📅 2025-06-09 by *Denis Bakhvalov*
...
* [Linux Basics for Hackers](https://github.com/ahegazy0/linux-basics-for-hackers-notes) ⭐ 1,731 | 🐛 0 | 📅 2026-09-12 by *Abdulrahman Hegazy*
...
* [FFmpeg School of Assembly Language](https://github.com/FFmpeg/asm-lessons) ⭐ 12,153 | 🐛 25 | 📅 2026-02-22
...
* [Introduction to Bash Scripting](https://github.com/bobbyiliev/introduction-to-bash-scripting) ⭐ 6,352 | 🐛 10 | 🌐 HTML | 📅 2026-02-11 by *Bobby Iliev*
...
* [Hacktical C: A practical hacker's guide to the C programming language](https://github.com/codr7/hacktical-c) ⭐ 1,128 | 🐛 0 | 🌐 C | 📅 2026-03-21
...
* [30 Days Of Python](https://github.com/Asabeneh/30-Days-Of-Python) ⭐ 74,220 | 🐛 213 | 🌐 Python | 📅 2026-09-10 by *Asabeneh*

* [Scientific Visualization: Python + Matplotlib](https://github.com/rougier/scientific-visualization-book) ⭐ 11,551 | 🐛 18 | 🌐 Python | 📅 2026-01-04 by *Nicolas Rougier*
...
* [MS-DOS development resources](https://github.com/SuperIlu/DOSDevelResources) ⭐ 150 | 🐛 0 | 📅 2026-09-18
...
* [Mathematics for Robotics](https://github.com/michiganrobotics/rob501) ⭐ 2,985 | 🐛 1 | 📅 2022-03-21 by *Jessy Grizzle*

* [Robotics & ROS 2 Essentials](https://github.com/henki-robotics/robotics_essentials_ros2) ⭐ 2,625 | 🐛 1 | 🌐 C++ | 📅 2025-11-25
...
* [Learn Vim (the Smart Way)](https://github.com/iggredible/Learn-Vim) ⭐ 15,222 | 🐛 18 | 🌐 Dockerfile | 📅 2026-09-07 by *Igor Irianto*
...
* [What happens when you type google.com into your browser's address box and press enter?](https://github.com/alex/what-happens-when) ⭐ 43,324 | 🐛 2,066 | 📅 2024-08-19 by *Alex Gaynor*
...
* [Playing with code](https://haqr.eu) by *Dmitry V. Sokolov*
  ...
  * **On the [author's GitHub](https://github.com/ssloy)**
    * [Tiny renderer or how OpenGL works: software rendering in 500 lines of code](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,268 | 🐛 4 | 🌐 C++ | 📅 2026-07-29
    * [Understandable RayTracing in 256 lines of bare C++](https://github.com/ssloy/tinyraytracer/wiki) ⭐ 5,371 | 🐛 16 | 🌐 C++ | 📅 2023-07-07
...
* [Build Your Own X](https://github.com/danistefanovic/build-your-own-x/blob/master/README.md) ⭐ 548,422 | 🐛 645 | 🌐 Markdown | 📅 2026-07-14

* [Project Based Learning](https://github.com/practical-tutorials/project-based-learning/blob/master/README.md) ⭐ 284,026 | 🐛 252 | 🌐 Python | 📅 2026-09-14

* [Awesome Math Books](https://github.com/valeman/Awesome_Math_Books) ⭐ 7,226 | 🐛 7 | 📅 2026-08-14
