...
* [Maths, CS & AI Compendium](https://github.com/HenryNdubuaku/maths-cs-ai-compendium) ⭐ 7,370 | 🐛 15 | 🌐 TypeScript | 📅 2026-07-18 by *Henry Ndubuaku*
...
* [Machine Learning Engineering Open Book](https://github.com/stas00/ml-engineering) ⭐ 18,714 | 🐛 4 | 🌐 Python | 📅 2026-08-26 by *Stas Bekman*
...
* [Mathematical Foundations of Reinforcement Learning](https://github.com/MathFoundationRL/Book-Mathematical-Foundation-of-Reinforcement-Learning) ⭐ 17,577 | 🐛 0 | 🌐 MATLAB | 📅 2026-08-10 by *Shiyu Zhao*
...
* [Monte-Carlo Graph Search from First Principles](https://github.com/lightvector/KataGo/blob/master/docs/GraphSearch.md) ⭐ 5,035 | 🐛 491 | 🌐 C++ | 📅 2026-08-25 by *David J Wu*
...
* [A Compiler Writing Journey](https://github.com/DoctorWkt/acwj) ⭐ 13,388 | 🐛 25 | 🌐 C | 📅 2026-06-06 by *Warren*
...
* [DirectX-Graphics-Samples](https://github.com/microsoft/DirectX-Graphics-Samples) ⭐ 6,819 | 🐛 112 | 🌐 C++ | 📅 2026-08-14
...
* [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,855 | 🐛 18 | 🌐 C++ | 📅 2023-06-25
...
* [A comprehensive guide for Linux Network (Socket) programming](https://github.com/nguyenchiemminhvu/LinuxNetworkProgramming) ⭐ 550 | 🐛 0 | 🌐 C | 📅 2025-01-19
...
* [Linux Basics for Hackers](https://github.com/ahegazy0/linux-basics-for-hackers-notes) ⭐ 1,302 | 🐛 0 | 📅 2026-06-04 by *Abdulrahman Hegazy*
...
* [Introduction to Bash Scripting](https://github.com/bobbyiliev/introduction-to-bash-scripting) ⭐ 6,316 | 🐛 10 | 🌐 HTML | 📅 2026-02-11 by *Bobby Iliev*
...
* [30 Days Of Python](https://github.com/Asabeneh/30-Days-Of-Python) ⭐ 71,947 | 🐛 199 | 🌐 Python | 📅 2026-08-20 by *Asabeneh*

* [Scientific Visualization: Python + Matplotlib](https://github.com/rougier/scientific-visualization-book) ⭐ 11,444 | 🐛 18 | 🌐 Python | 📅 2026-01-04 by *Nicolas Rougier*
...
* [Robotics & ROS 2 Essentials](https://github.com/henki-robotics/robotics_essentials_ros2) ⭐ 2,582 | 🐛 1 | 🌐 C++ | 📅 2025-11-25
...
* [Learn Vim (the Smart Way)](https://github.com/iggredible/Learn-Vim) ⭐ 15,202 | 🐛 19 | 🌐 Dockerfile | 📅 2026-04-23 by *Igor Irianto*
...
* [Playing with code](https://haqr.eu) by *Dmitry V. Sokolov*
  ...
  * **On the [author's GitHub](https://github.com/ssloy)**
    * [Tiny renderer or how OpenGL works: software rendering in 500 lines of code](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,146 | 🐛 4 | 🌐 C++ | 📅 2026-07-29
...
* [Build Your Own X](https://github.com/danistefanovic/build-your-own-x/blob/master/README.md) ⭐ 543,140 | 🐛 640 | 🌐 Markdown | 📅 2026-07-14

* [Project Based Learning](https://github.com/practical-tutorials/project-based-learning/blob/master/README.md) ⭐ 280,946 | 🐛 271 | 🌐 Python | 📅 2026-08-24

* [Awesome Math Books](https://github.com/valeman/Awesome_Math_Books) ⭐ 7,021 | 🐛 7 | 📅 2026-08-14
